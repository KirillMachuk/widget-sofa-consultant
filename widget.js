    ...
    <div class="vfw-hints" id="vfwHints">
      <div class="vfw-hint" id="vfwHintSingle">
        ...
        <div class="vfw-hint-content">
          Привет! 👋<br><br>Хотите подборку лучшей мебели для вашего интерьера со скидкой или подарком на выбор прямо в мессенджер?
        </div>
      </div>
    </div>
      ...
      const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
          if (entry.isIntersecting && els.panel.getAttribute('data-open') !== '1' && canShowHints()) {
            showHintsWithAutoHide('Привет! 👋\n\nХотите подборку лучшей мебели для вашего интерьера со скидкой или подарком на выбор прямо в мессенджер?');
            markTriggered();
            observer.disconnect();
          }
        });
