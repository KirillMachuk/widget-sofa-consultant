(function(){
  ...
  // Webflow-optimized version with CSS conflict protection
  ...
  style.textContent = `
    /* CSS Reset для защиты от конфликтов с платформами-конструкторами */
    .vfw-root,
    .vfw-root *,
    .vfw-root *::before,
    .vfw-root *::after {
    ...
    /* Кнопка виджета - максимальная защита от овальной формы */
    .vfw-btn {
    ...
    /* Изображение внутри кнопки - защита от растяжения */
    .vfw-btn img {
