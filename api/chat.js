  ...
  try{
    ...
    if (action === 'chat' && session_id && user_message) {
      ...
      if (isCircuitOpen()) {
        ...
        const fallbackText = 'Привет! Я консультант по диванам. Сейчас у меня небольшие технические сложности, но я могу помочь! Расскажите, какой диван вас интересует?';
