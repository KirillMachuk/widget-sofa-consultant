...
function checkIfNeedsFormMessage(reply, messages, userMessagesAfterLastForm = 0) {
  ...
  const formTriggers = [
    ...
    /(рассрочк|рассрочку|рассрочка|рассрочки|категорию мебели)/i
  ];
